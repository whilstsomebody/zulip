...
class MultiuseInviteTest(ZulipTestCase):
    ...
    def test_non_privileged_multiuse_invite_edits(self) -> None:
        ...
        * If the link invites users as moderators, the editing user must be a moderator themselves.
          The moderator can invite users as moderators or members.
    ...
    def test_admin_can_edit_multiuse_invite(self) -> None:
        ...
        self.assertEqual(
            set(modified_multiuse_object.streams.values_list("id", flat=True)),
